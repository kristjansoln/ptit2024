...
# VARIABLES
MAX_COMMAND_LEN = 15
commands = ["desno", "levo", "stop", "ustavi"]
...
phrase_time_limit = 2  # Length of phrase in seconds
...
while True:
    ...
    try:
        print("Got it! Running recognition...")
        # Recognize speech with whisper (on device)
        # speech = r.recognize_whisper(audio, language="sl", model="small")
        # speech = r.recognize_whisper(audio, model="tiny")
